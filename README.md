...
If you have any feedback or concerns, reach out to our security team on security@liquis.app.
...
See [docs](https://docs.liquis.app) for the list of mainnet contract addresses
